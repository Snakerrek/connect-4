var clicks = 0;
var player1 = "Gracz niebieski";
var player1color = "rgb(95, 120, 250)";

var player2 = "Gracz czerwony";
var player2color = "rgb(255, 68, 33)";
...
$(".board button").on("click", function functionName() {
  ...
  if (horizontalWinCheck() || verticalWinCheck() || diagonalWinCheck()) {
    $("h1").text(
      currentName + " wygrał po " + Math.ceil(clicks / 2) + " ruchach!"
    );
    $("h2").fadeOut(2000);
    $("h3").fadeOut(2000);
    $(".board").fadeOut(2000);
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $("h3").text(currentName + " - twoja kolej!");
